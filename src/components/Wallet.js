  ...
  return (
    <section className='bg-gray-100 text-gray-900 min-h-screen'>
      ...
      {user && user.emailVerified ?
        ...
        :
        <div className='big-gray-100 text-gray-900 min-h-screen'>
          <p className='text-4xl text-center'>Please verify email.
            <br />
            Verify Link has been sent to your email address
          </p>
        </div>}
